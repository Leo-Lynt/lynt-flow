...
import { areTypesCompatible as dataTypesCompatible, loadDataTypes, detectValueType } from './dataTypes.js'
...
export function getHandleType(nodeType, nodeData, handleId, position, flowStore = null) {
  // 1. Casos especiais legados - handles dinâmicos complexos que ainda não foram migrados
  ...
  // Suporte a dynamicHandles (ex: Variable node com modes diferentes)
